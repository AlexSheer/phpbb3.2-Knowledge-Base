...
$lang = array_merge($lang, array(
	...
	'CATEGORY_ADDED_WITH_PERM'						=> 'Категория успешно добавлена.',
	...
	'SORT_TYPE_EXPLAIN'								=> 'Если выбрано <strong>принудительно</strong>, то пользователь, имеющий модераторское право редактировать статьи, может расположить их внутри категории в произвольном порядке.
														Если выбрано <strong>выборочно</strong>, то пользователи могут сортировать статьи внутри категории обычным порядком.
														Если выбрано <strong>алфавитная навигация</strong>, то статьи отображаются в алфавитном порядке, при этом имеется возможность фильтровать статьи по первой букве заголовка.',
...
// Moderator Permissions
	...
	'LOG_KB_CONFIG_SEARCH'					=> '<strong>Изменены настройки поиска в Библиотеке</strong>',
	...
	'INDEXING_IN_PROGRESS_EXPLAIN'			=> 'Идёт индексация всех имеющихся статей. Этот процесс может занять от нескольких минут до нескольких часов в зависимости от объёма данных.',
	...
	'SEARCH_TYPE_EXPLAIN'					=> 'Расширение <strong>phpBB Knowledge Base</strong> позволяет выбрать механизм для осуществления поиска в статьях. По умолчанию используется собственный полнотекстовый поисковый механизм phpBB Knowledge Base.',
	...
	'LOG_KB_SEARCH_INDEX_REMOVED'		=> '<strong>Удалены поисковые индексы</strong>',
	'LOG_KB_SEARCH_INDEX_CREATED'		=> '<strong>Созданы поисковые индексы</strong>',
